...
export const DRUG_DB = [
  ...
  { name:"アジスロマイシン", brand:"ジスロマック錠", category:"抗菌薬(マクロライド系)",
    ...
    hd:"通常用量", pd:"通常用量", dialyzable:"×", caution:true,
    note:"QT延長に注意" },
  // アジルサルタン
  { name:"アジルサルタン", brand:"アジルバ錠", category:"降圧薬(ARB)",
    ...
    hd:"慎重投与", pd:"慎重投与", dialyzable:"×", caution:true },
  // アゾセミド
  { name:"アゾセミド", brand:"ダイアート錠", category:"利尿薬",
    normal:"1日1回30〜60mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"アモキシシリン・クラブラン酸", brand:"オーグメンチン配合錠", category:"抗菌薬(ペニシリン系)",
    ...
    hd:"透析後追加", pd:"慎重投与", dialyzable:"○", caution:true,
    note:"クラブラン酸蓄積に注意" },
  // アルファカルシドール
  { name:"アルファカルシドール", brand:"ワンアルファ錠", category:"活性型ビタミンD製剤",
    normal:"1日1回0.25〜1μg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"アロプリノール", brand:"アロプリノール錠", category:"尿酸生成抑制薬",
    ...
    hd:"透析患者は1日1回100mg（適正尿酸値コントロールが困難な場合あり）", pd:"同左", dialyzable:"○", danger:true, caution:true,
  ...
  { name:"イトラコナゾール", brand:"イトリゾールカプセル", category:"抗真菌薬",
    ...
    note:"CYP3A4阻害作用に注意" },
  // イミダプリル
  { name:"イミダプリル", brand:"タナトリル錠", category:"降圧薬(ACE阻害薬)",
    normal:"1日1回5〜10mg",
    ranges:[
      {ccr:[30,Infinity], dose:"通常用量"},
      {ccr:[10,30], dose:"5mg以下より開始"},
      {ccr:[0,10], dose:"少量より開始"}
    ],
    hd:"少量より開始", pd:"少量より開始", dialyzable:"○", caution:true },
  // イミペネム・シラスタチン
  { name:"イミペネム・シラスタチン", brand:"チエナム点滴静注", category:"抗菌薬(カルバペネム系)",
    ...
    hd:"HD後投与", pd:"慎重投与", dialyzable:"○", danger:true, caution:true,
    note:"痙攣に注意" },
  // エサキセレノン
  ...
  { name:"ST合剤（スルファメトキサゾール・トリメトプリム)", brand:"バクタ配合錠", category:"抗菌薬(ST合剤)",
    normal:"通常1〜2錠/日",
    ranges:[
      {ccr:[30,Infinity], dose:"通常用量"},
    ...
    hd:"透析後投与", pd:"慎重投与", dialyzable:"○", danger:true, caution:true,
    note:"高K血症・骨髄抑制・Cr上昇に注意" },
  // エゼチミブ
  { name:"エゼチミブ", brand:"ゼチーア錠", category:"脂質異常症治療薬",
    normal:"1日1回10mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"エナラプリル", brand:"レニベース錠", category:"降圧薬(ACE阻害薬)",
    ...
    ranges:[
      {ccr:[30,Infinity], dose:"通常用量"},
      {ccr:[10,30], dose:"2.5〜5mgより開始"},
      {ccr:[0,10], dose:"2.5mgより開始"}
    ],
    hd:"少量より開始", pd:"少量より開始", dialyzable:"○", caution:true,
    note:"開始後のCr上昇・高K血症に注意" },
  // エプレレノン
  { name:"エプレレノン", brand:"セララ錠", category:"MRA",
    normal:"1日1回25〜50mg",
    ranges:[
      {ccr:[50,Infinity], dose:"通常用量"},
      {ccr:[0,50], dose:"禁忌"}
  ...
  { name:"エポエチンベータペゴル", brand:"ミルセラ注", category:"ESA",
    ...
    hd:"通常用量", pd:"通常用量", dialyzable:"×" },
  // エボカルセト
  { name:"エボカルセト", brand:"オルケディア錠", category:"カルシウム受容体作動薬",
    normal:"1日1回1mgより開始",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"エルタペネム", brand:"インバンツ点滴静注", category:"抗菌薬(カルバペネム系)",
    ...
    hd:"HD後投与", pd:"慎重投与", dialyzable:"○", caution:true,
    note:"腎機能に応じ減量" },
  // エンテカビル
  { name:"エンテカビル", brand:"バラクルード錠", category:"B型肝炎治療薬",
    ...
    hd:"透析後投与", pd:"慎重投与", dialyzable:"○", caution:true,
    note:"腎機能に応じ減量" },
  // エンパグリフロジン
  ...
  { name:"オセルタミビル", brand:"タミフルカプセル・ドライシロップ", category:"抗インフルエンザ薬",
    ...
    hd:"治療：1回75mgを単回  予防：初回75mg、2回のHD後に75mg追加", pd:"初回75mg、7日目に75mg追加", dialyzable:"○", caution:true },
  // オルメサルタン
  ...
  { name:"ガバペンチン", brand:"ガバペン錠・シロップ", category:"抗てんかん薬",
    ...
    hd:"初日1日1回200mg、維持1日1回200mg、HDはHD後。または週3回HD後200〜400mg", pd:"GFR<15に準じる", dialyzable:"○", caution:true,
    note:"参考血中濃度：2〜20μg/mL" },
  // カルシトリオール
  { name:"カルシトリオール", brand:"ロカルトロールカプセル", category:"活性型ビタミンD製剤",
    normal:"1日0.25〜0.5μg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
    ...
    note:"Ca・P上昇に注意" },
  // カルベジロール
  { name:"カルベジロール", brand:"アーチスト錠", category:"降圧薬(β遮断薬)",
    normal:"1日1回10〜20mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"コルヒチン", brand:"コルヒチン錠", category:"痛風発作寛解・予防薬",
    ...
    hd:"禁忌（CYP3A4強阻害薬・P-gp阻害薬との併用は特に注意）", pd:"禁忌", dialyzable:"×", danger:true, caution:true },
  // サクビトリル・バルサルタン
  ...
  { name:"ジゴキシン", brand:"ジゴシン錠", category:"強心薬",
    ...
    hd:"原則避ける", pd:"慎重投与", dialyzable:"×", danger:true, caution:true,
    note:"中毒域に入りやすい" },
  // ジゴキシン（経口）
  { name:"ジゴキシン（経口）", brand:"ジゴシン錠・散・エリキシル", category:"強心配糖体",
    ...
    hd:"維持：約0.09mgを週3〜4回、心拍数・血中濃度を測定し調整（負荷量は通常通り）", pd:"同左", dialyzable:"×", caution:true,
  ...
  { name:"シドフォビル", brand:"ビスタイド注", category:"抗ウイルス薬",
    ...
    hd:"禁忌", pd:"禁忌", dialyzable:"×", danger:true,
    note:"強い腎毒性あり" },
  // シナカルセト
  { name:"シナカルセト", brand:"レグパラ錠", category:"カルシウム受容体作動薬",
    normal:"1日1回25mgより開始",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"ジフェリケファリン", brand:"コルスバ静注", category:"透析そう痒症治療薬",
    ...
    hd:"通常用量", pd:"適応あり", dialyzable:"×", caution:true,
    note:"傾眠・めまいに注意" },
  // シプロフロキサシン
  { name:"シプロフロキサシン", brand:"シプロキサン錠", category:"抗菌薬(ニューキノロン)",
    ...
    hd:"HD後投与", pd:"減量", dialyzable:"○", caution:true },
  // シベンゾリンコハク酸塩（経口）
  ...
  // ジルコニウムシクロケイ酸Na
  { name:"ジルコニウムシクロケイ酸Na", brand:"ロケルマ懸濁用散分包", category:"高K血症治療薬",
    normal:"維持量5gを1日1回",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"スクロオキシ水酸化鉄", brand:"ピートルチュアブル錠", category:"リン吸着薬",
    ...
    hd:"通常用量", pd:"通常用量", dialyzable:"×" },
  // スピロノラクトン
  { name:"スピロノラクトン", brand:"アルダクトンA錠", category:"MRA",
    normal:"1日25〜50mg",
    ranges:[
      {ccr:[30,Infinity], dose:"通常用量"},
      {ccr:[0,30], dose:"高K血症に注意し慎重投与"}
    ],
    hd:"慎重投与", pd:"慎重投与", dialyzable:"×", caution:true,
    note:"高K血症リスク" },
  // スルピリド
  ...
  { name:"セファゾリン", brand:"セファメジンα注", category:"抗菌薬(セフェム系)",
    ...
    hd:"HD後0.5〜1g", pd:"減量", dialyzable:"○", caution:true },
  // セフェピム
  ...
  { name:"セフメタゾール", brand:"セフメタゾン静注", category:"抗菌薬(セフェム系)",
    ...
    note:"腎機能に応じ減量" },
  // セベラマー
  { name:"セベラマー", brand:"レナジェル錠", category:"リン吸着薬",
    normal:"食直前または食直後",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"ソリフェナシン", brand:"ベシケア錠", category:"過活動膀胱治療薬",
    ...
    hd:"慎重投与", pd:"慎重投与", dialyzable:"×", caution:true },
  // タクロリムス
  { name:"タクロリムス", brand:"プログラフカプセル・顆粒", category:"免疫抑制薬",
    normal:"適応・トラフ値に応じて調節",
    ranges:[
      {ccr:[0,Infinity], dose:"腎機能による定型的減量基準なし。TDMにより調整"}
    ],
    hd:"透析による除去なし。通常は追加投与不要", pd:"HDに準じる", dialyzable:"×", caution:true,
  ...
  { name:"タゾバクタム・ピペラシリン", brand:"ゾシン静注", category:"抗菌薬(ペニシリン系)",
    ...
    hd:"HD後追加投与", pd:"減量", dialyzable:"○", caution:true },
  // ダパグリフロジン
  ...
  { name:"ダルベポエチンα", brand:"ネスプ注射液", category:"ESA",
    ...
    hd:"通常用量", pd:"通常用量", dialyzable:"×" },
  // 炭酸ランタン
  { name:"炭酸ランタン", brand:"ホスレノールOD錠", category:"リン吸着薬",
    normal:"食直後",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"テイコプラニン", brand:"タゴシッド注", category:"抗MRSA薬",
    ...
    hd:"TDMで調整", pd:"TDMで調整", dialyzable:"△", danger:true, caution:true,
    note:"TDM推奨" },
  // テノホビル アラフェナミド
  ...
  { name:"ドキシサイクリン", brand:"ビブラマイシン錠", category:"抗菌薬(テトラサイクリン系)",
    ...
    note:"腎機能による減量不要" },
  // トラセミド
  { name:"トラセミド", brand:"ルプラック錠", category:"利尿薬",
    normal:"1日1回4〜8mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  // トルバプタン
  { name:"トルバプタン", brand:"サムスカ錠", category:"利尿薬",
    normal:"1日1回7.5〜15mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
    hd:"適応なし", pd:"適応なし", dialyzable:"×", caution:true,
    note:"開始時は高Na血症・急激な水利尿に注意" },
  // トレラグリプチン
  ...
  { name:"バラシクロビル", brand:"バルトレックス錠・顆粒", category:"抗ウイルス薬",
    ...
    hd:"①1回体重55kg以上800mg・40〜55kg600mg・40kg未満400mg、HDはHD後  ②③1回200mgを1日1〜2回", pd:"同左", dialyzable:"○", caution:true,
  ...
  { name:"バンコマイシン", brand:"塩酸バンコマイシン点滴静注", category:"抗MRSA薬",
    ...
    hd:"25〜30mg/kg（DW）を負荷投与、毎HD後7.5〜10mg/kg（DW）投与", pd:"負荷量30mg/kg腹腔内、維持1.5mg/kg/バッグ腹腔内（間歇）", dialyzable:"△", caution:true,
    note:"TDM必須。目標トラフ：非複雑性15〜30μg/mL、複雑性20〜40μg/mL" },
  // ビソプロロール
  { name:"ビソプロロール", brand:"メインテート錠", category:"降圧薬(β遮断薬)",
    normal:"1日1回2.5〜5mg",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"ファモチジン", brand:"ガスター錠", category:"消化性潰瘍治療薬(H2RA)",
    ...
    hd:"HD後投与", pd:"減量して使用", dialyzable:"○", caution:true },
  // ファモチジン（経口）
  ...
  { name:"フルコナゾール（経口）", brand:"ジフルカンカプセル・ドライシロップ", category:"抗真菌薬",
    ...
    hd:"①②③HD終了後に通常用量", pd:"腹腔内間歇：150〜200mgを24〜48時間毎", dialyzable:"○", caution:true },
  // フルシトシン
  ...
  { name:"プレガバリン", brand:"リリカカプセル・OD錠", category:"神経障害性疼痛緩和薬",
    ...
    hd:"①②初期25mg 分1、維持25〜75mg 分1、最大1日150mg（HD後に補充投与）", pd:"同左", dialyzable:"○", caution:true,
  ...
  { name:"ホスカルネット", brand:"ホスカビル点滴静注", category:"抗ウイルス薬",
    ...
    hd:"慎重投与", pd:"慎重投与", dialyzable:"△", danger:true, caution:true,
    note:"腎毒性・低Ca血症に注意" },
  // ホスフルコナゾール
  ...
  // ポリスチレンスルホン酸Ca
  { name:"ポリスチレンスルホン酸Ca", brand:"アーガメイトゼリー", category:"高K血症治療薬",
    normal:"1回25〜50g",
    ranges:[
      {ccr:[0,Infinity], dose:"通常用量"}
    ],
  ...
  { name:"リポソームアムホテリシンB", brand:"アムビゾーム点滴静注", category:"抗真菌薬",
    ...
    hd:"通常用量", pd:"通常用量", dialyzable:"×", danger:true, caution:true,
    note:"腎障害・低K血症に注意" },
  // レナリドミド
  ...
  { name:"レベチラセタム（経口）", brand:"イーケプラ錠・ドライシロップ", category:"抗てんかん薬",
    ...
    hd:"1回500mgを1日1回、HDはHD後に1回250〜500mgを補充", pd:"1回500mgを1日1回", dialyzable:"○", caution:true,
    note:"参考血中濃度：12〜46μg/mL" },
  // レボフロキサシン
  { name:"レボフロキサシン", brand:"クラビット錠", category:"抗菌薬(ニューキノロン)",
    ...
    hd:"初回500mg、その後250mgを透析後", pd:"慎重投与", dialyzable:"△", danger:true, caution:true,
  ...
  { name:"ワルファリンカリウム", brand:"ワーファリン錠・顆粒", category:"抗凝固薬(クマリン系)",
    ...
    hd:"心房細動アブレーション周術期・機械弁術後・脳梗塞既往を除き、維持透析患者への使用は推奨されない", pd:"同左", dialyzable:"×", caution:true,
